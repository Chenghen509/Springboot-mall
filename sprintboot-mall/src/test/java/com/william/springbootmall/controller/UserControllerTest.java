...
public class UserControllerTest {
    ...
    public void register_success() throws Exception {
        queryUserConditions userRegisterRequest = new queryUserConditions();
    ...
    public void login_success() throws Exception {
        ...
        // 再測試登入功能
        queryUserConditions userLoginRequest = new queryUserConditions();
    ...
    private void register(queryUserConditions userRegisterRequest) throws Exception {
        String json = objectMapper.writeValueAsString(userRegisterRequest);
