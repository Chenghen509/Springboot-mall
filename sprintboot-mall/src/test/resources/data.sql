...
-- dcp_order, dcp_order_detail
INSERT INTO dcp_order (user_id, total_amount, created_date, last_modified_date) VALUES (1, 500690, '2022-06-30 11:10:00', '2022-06-30 11:10:00');
INSERT INTO dcp_order_detail (order_id, product_id, quantity, amount) VALUES (1, 1, 3, 90);
INSERT INTO dcp_order_detail (order_id, product_id, quantity, amount) VALUES (1, 2, 2, 600);
INSERT INTO dcp_order_detail (order_id, product_id, quantity, amount) VALUES (1, 5, 1, 500000);

INSERT INTO dcp_order (user_id, total_amount, created_date, last_modified_date) VALUES (1, 100000, '2022-06-30 12:03:00', '2022-06-30 12:03:00');
INSERT INTO dcp_order_detail (order_id, product_id, quantity, amount) VALUES (2, 4, 1, 100000);
